                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select id="projectId" class="form-control form-control-line">
                                            ...
                                            <c:forEach items="${projectList}" var="project">
                                                <c:choose>
                                                    <c:when test="${task.projectId == project.id}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="taskName" value="${task.taskName}" type="text" placeholder="Tên công việc"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                       <select id="userId" class="form-control form-control-line">
                                            <c:forEach items="${userList}" var="user" varStatus="loop">
	                                             <c:choose>
	                                                  <c:when test="${task.userId == user.id}">
	                                                      <option selected value="${user.id}">${user.firstName} ${user.lastName}</option>
	                                                  </c:when>
	                                                  <c:otherwise>
	                                                      <option disabled value="${user.id}">${user.firstName} ${user.lastName}</option>
	                                                  </c:otherwise>
	                                             </c:choose>
                                             </c:forEach>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="startDate" value="${task.startDate}" type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="endDate" value="${task.endDate}" type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Trang thái</label>
                                    <div class="col-md-12">
                                        <select id="statusId" class="form-control form-control-line">
                                           	<c:forEach items="${statusList}" var="status" varStatus="loop">
	                                             <c:choose>
	                                                  <c:when test="${task.statusId == status.id}">
								...
								<div class="form-group">
                                    <div class="col-sm-12">
                                        <a taskId="${task.id}" href="#" class="btn btn-success btn-update">Lưu lại</a>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a href="#" class="btn btn-success btn-update">Lưu lại</a>
                                        <a href="profile" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
