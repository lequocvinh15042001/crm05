                                    ...
                                    <tbody>
                                        <c:forEach var="user" items="${listUser}" varStatus="loop">
	                                        <tr>
								                ...
								                <td>
                                                    <a href="#" userId="${user.id}" class="btn btn-sm btn-primary btn-update">Sửa</a>
                                                    <a href="#" userId="${user.id}" class="btn btn-sm btn-danger btn-delete">Xóa</a>
                                                    <a href="#" userId="${user.id}" class="btn btn-sm btn-info btn-detail">Xem</a>
                                                </td>
								            </tr>
                                        </c:forEach>
                                    </tbody>
