                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <c:forEach items="${tasks}" var="task">
                                <c:if test="${task.statusTask != null && task.statusTask.equals('Chưa thực hiện')}">
						            <a href="#">
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            <c:forEach items="${tasks}" var="task">
                                <c:if test="${task.statusTask != null && task.statusTask.equals('Đang thực hiện')}">
						            <a href="#">
						                <div class="mail-contnet">
						                    <h5>${task.taskName}</h5>
						                    <span class="mail-desc"></span>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            <c:forEach items="${tasks}" var="task">
                                <c:if test="${task.statusTask != null && task.statusTask.equals('Đã hoàn thành')}">
						            <a href="#">
						                <div class="mail-contnet">
						                    <h5>${task.taskName}</h5>
						                    <span class="mail-desc"></span>
