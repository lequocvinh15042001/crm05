                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="logout" class="menu-logout">Đăng xuất</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                        ...
                        <div class="white-box">
                            <form action="add-user" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="fullname" value="${user.fullname}" id="fullname" type="text" placeholder="Johnathan Doe"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input type="email" id="email" value="${user.email}" placeholder="johnathan@admin.com"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="password" value="${user.password}" id="password" type="password" value="" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Phone No</label>
                                    <div class="col-md-12">
                                        <input name="phone" value="${user.phone}" id="phone" type="text" placeholder="123 456 7890"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <select name="idRole" id="roleId" class="form-control form-control-line">
	                                       <%--  <c:forEach items="${listRole}" var = "role">
											...
											<c:forEach items="${listRole}" var="role" varStatus="loop">
                                                <c:choose>
                                                    <c:when test="${user.role.getId() == role.getId()}">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a userId="${user.id}" href="#" class="btn btn-success btn-update">Update</button>
