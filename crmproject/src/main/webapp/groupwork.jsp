                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${projects}" var="project"  varStatus="loop">
                                         	<tr>
	                                            ...
	                                            <td>
	                                                <a href="#" projectId="${project.getId()}" class="btn btn-sm btn-primary btn-update">Sửa</a>
                                                    <a href="#" projectId="${project.getId()}" class="btn btn-sm btn-danger btn-delete">Xóa</a>
                                                    <a href="#" projectId="${project.getId()}" class="btn btn-sm btn-info btn-details">Xem</a>
	                                            </td>
                                          	</tr>
                                        </c:forEach>
                                    </tbody>
